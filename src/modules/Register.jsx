export default function register_module({handle_register}) {
    return (
        <>  
                <div className="register-module">
                    ...
                    <form target="_blank" action="http://localhost:5000/register" className="register-form mt-2" method="post" enctype="multipart/form-data">
                        ...
                        <input name="register-user" className="input-dft mt-1" type="text" id="register-user" placeholder="username" autoComplete="off"/>
